document.addEventListener('DOMContentLoaded', () => {
    ...
    if (video) {
        // When video ends, fade out and enter site
        video.addEventListener('ended', fadeOutPreloader);

        // Attempt programmatically playing the video in case autoplay attribute was blocked
        video.play().catch(error => {
            console.log("Autoplay was blocked or failed, waiting for user interaction/skip.", error);
        });
    }
    ...
    // Safety fallback: in case video gets stuck or fails to load, proceed after 10 seconds
    ...
    if (washForm) {
        washForm.addEventListener('submit', (e) => {
            ...
            // Route to correct WhatsApp number based on location
            const whatsappNumber = (washLocation === "Kottarakkara") ? "918848700790" : "918848900790";
    ...
    if (careerForm) {
        careerForm.addEventListener('submit', (e) => {
            ...
            // Route to correct WhatsApp number based on location selection
            const whatsappNumber = (location === "Kottarakkara") ? "918848700790" : "918848900790";
